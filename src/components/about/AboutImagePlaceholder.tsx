export function AboutImagePlaceholder() {
  return (
    <div className="relative flex h-[420px] w-full items-center justify-center overflow-hidden rounded-3xl border border-brand-navy-light/30 bg-brand-navy-light/20 shadow-xl shadow-brand-navy/30 backdrop-blur-md sm:h-[520px] lg:h-[620px]">
